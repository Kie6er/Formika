/******/ (function () {
	...
	!(function () {
		...
		var jquery_default = /*#__PURE__*/ __webpack_require__.n(jquery); // CONCATENATED MODULE: ./node_modules/imask/esm/core/utils.js
    ...
    */
		...
		IMask.createMask = createMask; // CONCATENATED MODULE: ./node_modules/imask/esm/controls/mask-element.js
  ...
  */
		...
		IMask.HTMLMaskElement = HTMLMaskElement; // CONCATENATED MODULE: ./node_modules/imask/esm/controls/html-input-mask-element.js
  ...
  */
		...
		IMask.InputMask = InputMask; // CONCATENATED MODULE: ./node_modules/imask/esm/core/change-details.js
		...
		IMask.ChangeDetails = ChangeDetails; // CONCATENATED MODULE: ./node_modules/imask/esm/core/continuous-tail-details.js
		...
		IMask.Masked = Masked; // CONCATENATED MODULE: ./node_modules/imask/esm/masked/pattern/chunk-tail-details.js
		...
		class PatternInputDefinition {
			...
			_appendChar(ch, flags) {
				...
				// simulate input
				const details = this.masked._appendChar(
					ch,
			...
			_rebuildMask() {
				...
				for (let i = 0; i < pattern.length; ++i) {
					if (this.blocks) {
						...
						if (bName) {
							const { expose, ...blockOpts } = normalizeOpts(
								this.blocks[bName]
							);
  ...
  */
		...
		IMask.MaskedDate = MaskedDate; // CONCATENATED MODULE: ./node_modules/imask/esm/masked/dynamic.js
		...
		IMask.MaskedDynamic = MaskedDynamic; // CONCATENATED MODULE: ./node_modules/imask/esm/masked/enum.js
		...
		IMask.MaskedEnum = MaskedEnum; // CONCATENATED MODULE: ./node_modules/imask/esm/masked/function.js
		...
		IMask.MaskedFunction = MaskedFunction; // CONCATENATED MODULE: ./node_modules/imask/esm/masked/number.js
  ...
  */
		...
		IMask.MaskedNumber = MaskedNumber; // CONCATENATED MODULE: ./node_modules/imask/esm/masked/pipe.js
		...
		} catch {} // CONCATENATED MODULE: ./node_modules/gsap/gsap-core.js
  ...
  */
			...
			_renderCSSTransforms = function _renderCSSTransforms(ratio, cache) {
				var _ref = cache || this,
					...
					transforms = "",
					use3D =
						(force3D === "auto" && ratio && ratio !== 1) || force3D === true; // Safari has a bug that causes it not to render 3D transform-origin values properly, so we force the z origin to 0, record it in the cache, and then do the math here to offset the translate values accordingly (basically do the 3D transform-origin part manually)
				...
				for (p in vars) {
					...
					if (specialProp) {
						...
						if (startAt && p in startAt) {
							...
							getUnit(startValue + "") ||
								(startValue +=
									_config.units[p] || getUnit(_get(target, p)) || ""); // for cases when someone passes in a unitless value like {x: 100}; if we try setting translate(100, 0px) it won't work.
		...
		var gsapWithCSS = gsap.registerPlugin(CSSPlugin) || gsap,
			...
			TweenMaxWithCSS = gsapWithCSS.core.Tween; // CONCATENATED MODULE: ./node_modules/gsap/Observer.js
		...
		var Observer_gsap,
			...
			_getScrollFunc = function _getScrollFunc(element, _ref) {
				...
				prev ||
					(func.smooth =
						Observer_gsap.getProperty(element, "scrollBehavior") === "smooth"); // only set it the first time (don't reset every time a scrollFunc is requested because perhaps it happens during a refresh() when it's disabled in ScrollTrigger.
		...
		var Observer = /*#__PURE__*/ (function () {
			...
			_proto.init = function init(vars) {
				...
				lineHeight ||
					(lineHeight =
						parseFloat(Observer_win.getComputedStyle(_body).lineHeight) || 22); // note: browser may report "normal", so default to 22.
		...
		_getGSAP() && Observer_gsap.registerPlugin(Observer); // CONCATENATED MODULE: ./node_modules/gsap/ScrollTrigger.js
		...
		var ScrollTrigger_gsap,
			...
			_keepClamp = function _keepClamp(value, clamp) {
				return clamp &&
					(!ScrollTrigger_isString(value) || value.substr(0, 6) !== "clamp(")
					? "clamp(" + value + ")"
					: value;
			},
			...
			_clearScrollMemory = function _clearScrollMemory(
				...
				(force || !_refreshingAll) &&
					_scrollers.forEach(function (obj) {
						return (
							ScrollTrigger_isFunction(obj) && obj.cacheID++ && (obj.rec = 0)
						);
					});
			...
			_refreshAll = function _refreshAll(force, skipRevert) {
				...
				_triggers.forEach(function (t) {
					return (
						ScrollTrigger_isFunction(t.vars.onRefresh) && t.vars.onRefresh(t)
					);
				});
			...
			_setState = function _setState(state) {
				if (state) {
					...
					).uncache = 1; // otherwise transforms may be off
				...
				if (ScrollTrigger_gsap) {
					...
					if (ScrollTrigger_body) {
						...
						ScrollTrigger_addListener(
							...
							"wheel",
							ScrollTrigger_onScroll
						); // mostly for 3rd party smooth scrolling libraries.
		...
		ScrollTrigger_getGSAP() &&
			ScrollTrigger_gsap.registerPlugin(ScrollTrigger_ScrollTrigger); // CONCATENATED MODULE: ./src/js/components/header.js
		...
		jquery_default()(document).ready(function () {
			...
			jquery_default()(".burger-btn").on("click", function () {
				if (
					...
					jquery_default()(".banner-back").outerHeight()
				) {
					openBurgerMenu();
				} else {
		...
		jquery_default()(document).ready(function () {
			...
			function switchModalContent() {
				jquery_default()(".modal")
					.find(".modal-content--first")
					.removeClass("active");
				jquery_default()(".modal")
					.find(".modal-content--second")
					.addClass("active");
			}
			function validationForm(form) {
				...
				function createError(input, text) {
					const errorText = jquery_default()(
			...
			inputFile.forEach((el) => {
				jquery_default()(el).on("change", () => {
					if (el.files.length) {
						...
						jquery_default()(el)
							.siblings(".custom-preview")
							.find(".custom-preview__name")
							.text(fileName);
						jquery_default()(el)
							.siblings(".custom-preview")
							.find(".custom-preview__size")
							.text(`${fileSize}KB`);
						if (fileSize >= 1024) {
		...
		jquery_default()(document).ready(function () {
			...
			mainPageMm.add("(min-width: 769px)", () => {
				// desktop
				jquery_default()(".main-solutions").length > 0 &&
				ScrollTrigger_ScrollTrigger.isTouch !== 1
					? mainSolutionAnimDesktop()
					: null;
				if (
					jquery_default()(".main-projects").length > 0 &&
					ScrollTrigger_ScrollTrigger.isTouch !== 1
				) {
					...
					const projectsResizeObserver = new ResizeObserver(
			...
			function mainProjectsAnimMobile() {
				const projectsImages = gsapWithCSS.utils.toArray(
					".main-projects__content-item img"
				);
			...
			function mainProjectsAnimDesktop() {
				...
				const projectsItemsLeft = gsapWithCSS.utils.toArray(
					".main-projects__content-left .main-projects__content-item"
				);
				const projectsItemsRight = gsapWithCSS.utils.toArray(
					".main-projects__content-right .main-projects__content-item"
				);
				projectsDeskTimeline
					.to(".main-projects__subtitle", {
						scrollTrigger: {
							...
							start: "top 40%",
								...
								`${
									jquery_default()(".main-projects").height() -
									jquery_default()(".main-projects__content-item").height() /
										1.5
								} 50%`,
						},
					})
				...
				jquery_default()(".main-projects__content-item--btn").on(
					"click",
					function (evt) {
						evt.preventDefault();
						if (jquery_default()(this).hasClass("active")) {
							...
							jquery_default()(".main-projects__content-hidden").each(function (
								i,
								el
							) {
							...
							jquery_default()(".main-projects__content-hidden").each(function (
								...
								setTimeout(() => {
									jquery_default()(el).css(
										"max-height",
										51 *
											jquery_default()(this).find(
			...
			function mainShowProjectsAnimMobile() {
				jquery_default()(".main-projects__content-item--btn").on(
					"click",
					function (evt) {
						const content = jquery_default()(
							".main-projects__content-hidden--mobile"
						);
						evt.preventDefault();
						if (jquery_default()(this).hasClass("active")) {
							jquery_default()(this).removeClass("active");
							...
							setTimeout(() => {
								...
								content.css(
									"max-height",
									51 * content.find(".main-projects__content-item").length +
										"rem"
								);
							}, 0);
						}
			...
			markers.forEach((el) => {
				...
				jquery_default()(marker).addClass(
					`main-map__map-marks--item ${el.active ? "active" : " "}`
				);
		...
		`
				...
				if (window.outerWidth > 768) {
					...
					jquery_default()(marker).css(
						"top",
						`${el.coordinate[0] * 1.6 - 3}rem`
					);
					jquery_default()(marker).css(
						"left",
						`${el.coordinate[1] * 1.6 + 5}rem`
					);
				}
		...
		jquery_default()(document).ready(function () {
			...
			const projectItemSmallBottom =
				gsapWithCSS.utils.toArray(".small--bottom");
			const projectItemBig = gsapWithCSS.utils.toArray(".item-big-anim");
			const projectItemImage = gsapWithCSS.utils.toArray(
				".project-content__item img"
			);
			projectPageMm.add("(min-width: 769px)", () => {
				// desktop
				if (
					jquery_default()(".project-content").length > 0 &&
					ScrollTrigger_ScrollTrigger.isTouch !== 1
				) {
			...
			if (jquery_default()(".project-video").length > 0) {
				jquery_default()(".project-video").on("click", function () {
					if (
						jquery_default()(".project-video__button-play").hasClass("active")
					) {
						jquery_default()(".project-video__button-pause").addClass("active");
						jquery_default()(".project-video__button-play").removeClass(
							"active"
						);
						jquery_default()(this).find("video")[0].play();
					} else if (
						jquery_default()(".project-video__button-pause").hasClass("active")
					) {
						jquery_default()(".project-video__button-pause").removeClass(
							"active"
						);
		...
		jquery_default()(document).ready(function () {
			...
			aboutPageMm.add("(min-width: 769px)", () => {
				// desktop
				jquery_default()(".services-banner").length > 0
					? serviceBannerAnimDesk()
					: null;
			...
			function serviceBannerAnimDesk() {
				...
				jquery_default()(".services-banner__list button").each(function (
					i,
					el
				) {
					jquery_default()(el).on("click", function (evt) {
						jquery_default()(".services-banner__list li").each(function (
							i,
							el
						) {
			...
			function serviceProjectsAnimDesktop() {
				...
				const serviceItemsLeft = gsapWithCSS.utils.toArray(
					".services-cases__content-left .services-cases__content-item"
				);
				const serviceItemsRight = gsapWithCSS.utils.toArray(
					".services-cases__content-right .services-cases__content-item"
				);
				...
				jquery_default()(".services-cases__content-item--btn").on(
					"click",
					function (evt) {
						evt.preventDefault();
						if (jquery_default()(this).hasClass("active")) {
							...
							jquery_default()(".services-cases__content-hidden").each(
								function (i, el) {
									jquery_default()(el).css("max-height", "0");
									setTimeout(() => {
										jquery_default()(el).css("display", "none");
			...
			function serviceProjectsAnimMobile() {
				const serviceImages = gsapWithCSS.utils.toArray(
					".services-cases__content-item img"
				);
			...
			function serviceShowProjectsAnimMobile() {
				jquery_default()(".services-cases__content-item--btn").on(
					...
					function (evt) {
						const content = jquery_default()(
							".services-cases__content-hidden--mobile"
						);
						evt.preventDefault();
						if (jquery_default()(this).hasClass("active")) {
							jquery_default()(this).removeClass("active");
							...
							setTimeout(() => {
								...
								content.css(
									"max-height",
									51 * content.find(".services-cases__content-item").length +
										"rem"
								);
							}, 0);
						}
			...
			function serviceBannerMob() {
				jquery_default()(".services-banner__list button").on(
					"click",
					function (evt) {
						jquery_default()(".services-banner__list li").each(function (
							i,
		...
		jquery_default()(document).ready(function () {
			...
			aboutPageMm.add("(min-width: 769px)", () => {
				// desktop
				jquery_default()(".about-circles").length > 0 &&
				ScrollTrigger_ScrollTrigger.isTouch !== 1
					? aboutCirclesAnimDesk()
					: null;
				jquery_default()(".about-wedo").length > 0 &&
				ScrollTrigger_ScrollTrigger.isTouch !== 1
					? aboutWedoAnimDesk()
					: null;
			});
			...
			function aboutWedoAnimDesk() {
				...
				const listItems = gsapWithCSS.utils.toArray(
					".about-wedo__list li strong"
				);
			...
			accordionBtn.forEach((el) => {
				...
				el.addEventListener("click", () => {
					...
					if (el.classList.contains("active")) {
						document
							.querySelectorAll(".about-wedo__accordion-content")
